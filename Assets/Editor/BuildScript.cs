...
public static class BuildScript
{
    public static void BuildIos()
    {
        ...
        const string appIconPath = "Assets/Brand/GrandstayManager-AppIcon.png";
        Directory.CreateDirectory(outputPath);

        PlayerSettings.companyName = "Playable Games";
        PlayerSettings.productName = "Grandstay Manager";
        PlayerSettings.SetApplicationIdentifier(BuildTargetGroup.iOS, "com.play.HotelManagement");
